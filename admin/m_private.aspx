<%@ Page Title="Private Messages" Language="C#" MasterPageFile="~/admin/admin_master.master" AutoEventWireup="true" CodeFile="m_private.aspx.cs" Inherits="admin_m_private" %>
    ...
    <div class="content-box">
        ...
        <div class="content-box-content">
            ...
            <asp:GridView ID="gvUserMessage" runat="server" AutoGenerateColumns="False" CssClass="GridClass"
                ...
                PageSize="60">
                <Columns>
                    <asp:BoundField DataField="online_name" HeaderText="MESSAGE TO">
